...
-- Update existing members to be board members for the current period
-- This assumes the members already exist in the members table

-- Update Alicia Nuñez Puerto (asociaciones@animacionesmia.com)
UPDATE members SET
...
-- Update Daysi Cruz (presidencia@animacionesmia.com)
UPDATE members SET
    is_board_member = true,
